...
let { Machine, MachineType, Material, MaterialType,
  Supply, SupplyType } = require('../../models');
...
router.post('/machines', (req, res, next) => {
  let {name, price, brand, typeId: type_id, weigth ,
    meassurement: weigth_type} = req.body;
  let data = {name, price, brand, type_id, weigth, weigth_type};
